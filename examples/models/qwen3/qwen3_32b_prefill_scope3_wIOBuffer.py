...
# -----------------------------------------------------------------------------------------------------------
"""Qwen3-32B prefill Scope 3 — with I/O buffer caching (via io_cache plugin).

Identical kernel program to qwen3_32b_prefill_scope3.py.  All program,
...
"""
from qwen3_32b_prefill_scope3 import (
    build_prefill_scope3_program,
    build_tensor_specs,
    golden_prefill_scope3,
    BATCH, MAX_SEQ, HIDDEN, INTERMEDIATE,
)
...
def compile_and_run(
    ...
    golden = wrap_golden(golden_prefill_scope3, "out", cache_dir, tensor_specs)
