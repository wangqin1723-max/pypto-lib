...
"""DeepSeek-V4 prefill csa scaffold.
...
from prefill_attention_csa_draft import B, D, HC_MULT, S
...
def golden_prefill_csa(tensors):
    import torch

    from prefill_attention_csa_draft import golden_prefill_attention_csa
    ...
    golden_prefill_attention_csa(attn_tensors)
...
def build_tensor_specs(*args, **kwargs):
    from decode_csa import build_tensor_specs as _build_tensor_specs
