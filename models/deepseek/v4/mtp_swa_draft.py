...
from mtp_attention_swa_draft import B, D, HC_MULT, S
...
def golden_mtp_swa(tensors):
    import torch

    from mtp_attention_swa_draft import golden_mtp_attention_swa
    ...
    golden_mtp_attention_swa(attn_tensors)
